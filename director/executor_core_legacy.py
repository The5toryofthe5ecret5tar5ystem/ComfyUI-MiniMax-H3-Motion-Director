...
def _compose_mask_check_jpeg(visible, mask_vis, motion_ref, lead=0):
    """Side-by-side JPEG sanity check: source | subject overlay | motion ref.
    ...
    x += b.width + gap
    _paste(c, x, "motion ref (negative/blur)")
    buf = io.BytesIO()
