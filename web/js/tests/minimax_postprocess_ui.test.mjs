...
assert.deepEqual(globalRefineVisibility(cfg),{secondSampling:true,upscaleEnabled:false,seedOffset:false,tiled:false,temporal:false,upscaleModel:false,learnedLatent:false,vsr:false,seedvr2:false,seedvr2Status:false,aspectMegapixels:false,customSize:false});
